...
namespace Business
{
    public partial class BusinessStartup
    {
        ...
        public void ConfigureDevelopmentServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ISensorSettingRepository, SensorSettingRepository>();
            services.AddTransient<ISensorLocationRepository, SensorLocationRepository>();
            services.AddTransient<ISensorRepository, SensorRepository>();
            services.AddTransient<IParameterRepository, ParameterRepository>();
            services.AddTransient<ILocationRepository, LocationRepository>();
            services.AddTransient<IAlertActionRepository, AlertActionRepository>();
